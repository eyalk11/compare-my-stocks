#!/usr/bin/env python
"""Manual test runner for test_common.py with proper imports"""
import sys
import os

# Ensure the package is imported so sys.path is set up correctly
import compare_my_stocks

# Now imports should work the same way as in the tests
